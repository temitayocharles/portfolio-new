...
Phase 1: Strategy and source-of-truth mapping.

## Workstreams

| ID | Workstream | Status | Output | Acceptance criteria |
| --- | --- | --- | --- | --- |
| BHV2-001 | Ecosystem map | In progress | `docs/marketing/infraforge-ecosystem-map.md` | Every system has role, problem, solution, proof, and website priority. |
| BHV2-002 | Brand hub V2 plan | In progress | `docs/marketing/portfolio-website-v2-plan.md` | Defines homepage hierarchy, visual direction, content model, and phased PR plan. |
...
| BHV2-004 | Iris positioning correction | Planned | Content model update | Iris is represented as personal AI operator, not engineering assistant. |
| BHV2-005 | Jerry/ForgeWatch relationship | Planned | Ecosystem section + diagram copy | Jerry, Iris, ForgeWatch, and InfraForge relationship is clear without over-explaining. |
