...
export const projects = [
  ...
  },
  {
    ...
    subtitle: "Security Operations Assistant for Lean Teams",
    category: "AIOps / SecOps",
    description:
      "A Python prototype for lean security and operations teams that need guided checks, reusable investigation flows, assistant-backed triage, and safer recommendations before human-approved action.",
    stack: ["Python", "Automation", "Security Workflows", "Ops Intelligence"],
    pillars: ["SecOps", "AIOps", "Triage"],
    outcomes: ["Guided investigation flow", "Security workflow patterns", "Reusable triage logic"],
...
export const architectureScenarios = [
  ...
  },
  {
    ...
    summary:
      "A safer operations pattern for startups and lean teams: telemetry and logs are gathered first, AI produces an evidence-ranked recommendation, and execution remains approval-gated instead of blindly automated.",
  ...
  },
  {
    ...
    summary:
      "The business delivery path connects CI, immutable image promotion, GitOps reconciliation, Netlify frontend deployment, and API routing into a visible release lane with rollback points.",
